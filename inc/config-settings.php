 ...
 * Config Settings
 */
function contrix_csp_get_options(){

    /**
     * Create new menus
     */

    $contrix_csp_options[ ] = array(
        "type" => "menu",
        "menu_type" => "add_options_page",
        "page_name" => __( "Coming Soon", 'coming-soon' ),
        "menu_slug" => "contrix_csp",
        "layout" => "2-col"
    );
    ...
    $contrix_csp_options[ ] = array(
        "type" => "tab",
        "id" => "contrix_csp_setting",
        "label" => __( "Content", 'coming-soon' ),
    );

    $contrix_csp_options[ ] = array(
        "type" => "setting",
        "id" => "contrix_csp_settings_content",
    );

    $contrix_csp_options[ ] = array(
        "type" => "section",
        "id" => "contrix_csp_section_general",
    ...
    $csp_maintenance_file = WP_CONTENT_DIR."/maintenance.php";
    if (file_exists($csp_maintenance_file)) {
    $contrix_csp_options[ ] = array(
        "type" => "checkbox",
    ...
    $contrix_csp_options[ ] = array(
        "type" => "section",
        "id" => "contrix_csp_section_page_settings",
    ...
    $contrix_csp_options[ ] = array(
     ...
     $contrix_csp_options[ ] = array( "type" => "radio",
        "id" => "footer_credit",
        "label" => __("Powered By ContrixLab", '3d-coming-soon-page'),
    ...
    $contrix_csp_options[ ] = array(
        "type" => "tab",
        "id" => "contrix_csp_design",
        "label" => __( "Design", 'coming-soon' )
    );

    $contrix_csp_options[ ] = array(
        "type" => "setting",
        "id" => "contrix_csp_settings_design"
    );
    ...
    $contrix_csp_options[ ] = array(
        "type" => "section",
        "id" => "contrix_csp_section_background",
    ...
    $contrix_csp_options[ ] = array(
        ...
        "option_values" => apply_filters('contrix_csp_fonts',array(
            '_arial'     => 'Arial',
    ...
    $contrix_csp_options[ ] = array(
        "type" => "section",
        "id" => "contrix_csp_section_template",
    ...
    $contrix_csp_options[ ] = array(
        "type" => "tab",
        "id" => "contrix_csp_advanced",
        "label" => __( "Advanced", 'coming-soon' )
    );

    $contrix_csp_options[ ] = array(
        "type" => "setting",
        "id" => "contrix_csp_settings_advanced"
    );
    ...
    $contrix_csp_options[ ] = array(
        "type" => "section",
        "id" => "contrix_csp_section_scripts",
