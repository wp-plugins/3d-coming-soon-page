...
//                            }
            ...
            public function _options_page_html() {
                ...
                echo '<a href="javascript:void(0);" class="expand_options' . $expanded . '">' . __( 'Expand', 'coming-soon' ) . '</a>';
                echo '<div class="redux-action_bar">';
                echo '<a class="button-primary contrix_csp-preview " href="'.home_url().'?cs_preview=true" title="'.__('Preview Coming Soon Page','coming-soon').'">'.__('Live Preview','coming-soon').'</a>';
                echo '&nbsp;';
                submit_button( __( 'Save Changes', 'coming-soon' ), 'primary', 'redux_save', false );
                ...
                if ( false === $this->args['hide_reset'] ) {
                   ...
                   // submit_button( __( 'Reset Section', 'redux-framework' ), 'secondary', $this->args['opt_name'] . '[defaults-section]', false );
                    echo '&nbsp;';
                    submit_button( __( 'Reset All', 'coming-soon' ), 'secondary', $this->args['opt_name'] . '[defaults]', false );
                }

                echo '</div>';

                echo '<div class="redux-ajax-loading" alt="' . __( 'Working...', 'coming-soon' ) . '">&nbsp;</div>';
                echo '<div class="clear"></div>';
                echo '</div>';
                ...
                if ( isset( $this->transients['last_save_mode'] ) ) {
                    ...
                    if ( $this->transients['last_save_mode'] == "import" ) {
                         ...
                         */
                        echo '<div class="saved_notice admin-notice notice-green"><strong>' . apply_filters( "redux-saved-text-{$this->args['opt_name']}", __( 'Settings Saved!', 'coming-soon' ) ) . '</strong></div>';
                    }
                 ...
                 */
                echo '<div class="redux-save-warn notice-yellow"><strong>' . apply_filters( "redux-changed-text-{$this->args['opt_name']}", __( 'Settings have changed, you should save them!', 'coming-soon' ) ) . '</strong></div>';
